...
list = ("пара-ра-рам рам-пуум-пупам па-ре-по-дам")
def function_name(list):
    return sum(1 for i in list if i in 'аеёиоуыэюя')
    
list2 = list.lower().split()
temp = function_name(list2[0])
if all([function_name(i) == temp for i in list2]):
    print('True')
else:
    print('False')